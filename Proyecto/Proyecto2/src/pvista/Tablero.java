    ...
    public void paintComponent(Graphics g) {
        ...
        for (int i = 0; i < matriz.length; i++) {
                for (int j = 0; j < matriz[i].length; j++) {
                    ...
                    int px = (2+(33*i));
                    int py = (2+(33*j));
                    if(matriz[i][j].getClass().getName().equals("pmodelo.PiezaBarco")){
                    ...
                    } else if (this.matriz[i][j].getClass().getName().equals("pmodelo.PiezaBarco")
        ...
        for (int i = 0; i < matriz2.length; i++) {
                for (int j = 0; j < matriz2[i].length; j++) {
                    ...
                    int px = (506+2+(33*i));
                    int py = (2+(33*j));
                    if(matriz2[i][j].getClass().getName().equals("pmodelo.PiezaBarco")){
                        g2.drawImage(((PiezaBarco) matriz2[i][j]).getShipImage(), px, py, this);
                    } else if ((int)matriz2[i][j] == 0) {
                        g2.drawImage(new ImageIcon("agua.png").getImage(), px, py, this);
                    } else if (this.matriz2[i][j].getClass().getName().equals("pmodelo.PiezaBarco")
